...
class PaymentsFrame(tb.Frame):
    ...
    def _create_methods_breakdown(self, parent: ttk.Widget) -> None:
        ...
        self.method_bars: dict[str, Meter] = {}
        for key, label in [("cash", "نقدي"), ("card", "بطاقة"), ("transfer", "تحويل")]:
            ...
            m = Meter(row, metersize=60, amounttotal=100, amountused=0, metertype="semi", bootstyle="info")
            m.pack(side="left")
            self.method_bars[key] = m
